...
foreach($result as $row)
{
 ...
 $sub_array[] = '<button type="button" name="category_delete" id="'.$row["category_id"].'" class="btn btn-danger btn-xs category_delete" data-status="'.$row["category_status"].'">Delete</button>';
 $data[] = $sub_array;
}
